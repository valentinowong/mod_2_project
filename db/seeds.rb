...
game2 = Game.create(name: "Flatiron Hunt", description: "A fast-paced, fun-filled scavenger hunt where you get to know your classmates 📸")

mission101 = Mission.create(name: "AJ", content: "Take a picture of AJ!", game_id: Game.find_by(name: "Flatiron Hunt").id)
mission101 = Mission.create(name: "Alyssa", content: "Take a picture of Alyssa!", game_id: Game.find_by(name: "Flatiron Hunt").id)
mission101 = Mission.create(name: "Andrew", content: "Take a picture of Andrew!", game_id: Game.find_by(name: "Flatiron Hunt").id)
mission101 = Mission.create(name: "Hyo", content: "Take a picture of Hyo!", game_id: Game.find_by(name: "Flatiron Hunt").id)
mission101 = Mission.create(name: "Jason", content: "Take a picture of Jason!", game_id: Game.find_by(name: "Flatiron Hunt").id)
mission101 = Mission.create(name: "Varun", content: "Take a picture of Varun!", game_id: Game.find_by(name: "Flatiron Hunt").id)
mission101 = Mission.create(name: "Instructor", content: "Take a picture of any of the instructors!", game_id: Game.find_by(name: "Flatiron Hunt").id)